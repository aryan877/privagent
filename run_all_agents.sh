...
echo ""
echo "📝 Watching for agent addresses..."
echo ""
sleep 5
echo "================================================"
echo "🤖 AGENT ADDRESSES (copy these for ASI:One):"
echo "================================================"
echo ""
echo "To find your agent addresses, check the output above for lines like:"
echo "  'Your agent's address is: agent1q...'"
echo ""
echo "OR run this command in another terminal:"
echo "  grep -r 'agent.address' ~/.uagents/"
echo ""
echo "To test via ASI:One:"
echo "  1. Copy the COORDINATOR agent address from output above"
echo "  2. Go to https://asi1.ai"
echo "  3. Search for your coordinator address"
